...
import devicelist.HiosList;

public final class hiosreport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<head>\n");
      out.write("<title>HIOS Report</title>\n");
      ...
      out.write("<body>\n");
      out.write(" ");
      devicelist.HiosList admin = null;
      synchronized (_jspx_page_context) {
        admin = (devicelist.HiosList) _jspx_page_context.getAttribute("admin", PageContext.PAGE_SCOPE);
        if (admin == null){
          admin = new devicelist.HiosList();
      ...
      out.write("            <h5>Device List</h5>\n");
      out.write("          </div>\n");
      out.write("          <div class=\"widget-content nopadding\">\n");
      out.write("            <table class=\"table table-bordered data-table\">\n");
      out.write("              <thead>\n");
      out.write("                <tr>\n");
      out.write("                   <th>Port</th><br></br>\n");
      out.write("                   <th>Is power</th>\n");
      out.write("                   <th>Device</th>\n");
      out.write("                   <th>User</th>\n");
      out.write("                   <th>Device type</th>\n");
      out.write("                   <th>Management Ip</th>\n");
      out.write("                   <th>Console_details</th>\n");
      ...
      out.write("                 <tr>\n");
      out.write("                      <td>");
      out.print(obj.getPort());
      out.write("</td>\n");
      out.write("                     <td>");
      out.print(obj.getIs_power());
      out.write("</td>\n");
      out.write("                    \n");
      out.write("                          <td>");
      out.print(obj.getDevice());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(obj.getUser_info());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(obj.getDevice_type());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(obj.getManagement_ip());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(obj.getConsole_details());
      out.write("</td>\n");
      out.write("                            <td>");
      out.print(obj.getRemarks());
      out.write("</td>\n");
      out.write("                              \n");
      out.write("                     \n");
      ...
      out.write("                        });\n");
      out.write("                        alert(txt);\n");
      out.write("                    var url = \"hiosupdate.jsp?data=\"+txt;\n");
