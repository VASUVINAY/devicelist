...
<%@page import="devicelist.sheet2pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Sheet2 Report</title>
<meta charset="UTF-8" />
...
<body>
 <jsp:useBean id="admin" class="devicelist.sheet2pojo"></jsp:useBean>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                <%
                   ArrayList<sheet2pojo> data=dao.Fetch2();
                   
                   for(sheet2pojo obj:data)
                   {
                   %>
                 <tr>
               ...
               $('.update').click(function()
               {
                   ...
                   $(this).text($(this).text()==="Update"?"Save":"Update");
                    if($(this).text()==="Update")
                    {
                        ...
                        alert(txt);
                    var url = "sheet2update.jsp?data="+txt;
